...
const { register,login, followuser, logout, updatepass, updateprof, deleteprofile, myprofile, getuserprof, getallusers, forgetpass, resetpassword } = require("../controllers/user");
